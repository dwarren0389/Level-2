...
function addDelete(container){
    ...
    deleteButton.className = "delete-this"
...
function filledTodo(item, container){
    ...
    if (item.price){
        ...
        todoPrice.className = "todo-price-amount"
...
function addEditButton(container){
    ...
    editButton.textContent = "Edit This"
    editButton.className = "edit-this"
